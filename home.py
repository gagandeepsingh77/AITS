...
def app():
    ...
    with col2:
        ...
        st.write("Gagandeep Singh")
        st.write("Neelesh Durgapal")
        st.write("Bhaskar Joshi")
        st.write("Shubham Joshi")
        
        st.subheader("")
        st.write("The source code for the website is present in the below github link")
        github_link = '<a href="https://github.com/gagandeepsingh77/IPL-Data-Analysis" target="_blank" ' \
